...
export interface ScreenProps {
    route: RouteProp<NavegacaoPrincipalParams, "categoria">
}


export function Categoria(props:ScreenProps) {

  type navProp = StackNavigationProp<NavegacaoPrincipalParams, "categoria">;
